...
import (
	...
	"github.com/daudcanugerah/k6/internal/js/modules/k6/browser/keyboardlayout"
)
...
func TestKeyboardPress(t *testing.T) {
	...
	t.Run("meta", func(t *testing.T) {
		t.Parallel()
		t.Skip("FIXME") // See https://github.com/daudcanugerah/k6/js/modules/k6/browser/issues/424
		tb := newTestBrowser(t)
		p := tb.NewPage(nil)
		kb := p.GetKeyboard()
