...
func TestFrameNoPanicWithEmbeddedIFrame(t *testing.T) {
	...
	// CI: https://github.com/daudcanugerah/k6/js/modules/k6/browser/issues/678
...
// Without the fix in https://github.com/daudcanugerah/k6/js/modules/k6/browser/pull/942
