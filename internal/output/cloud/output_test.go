...
import (
	...
	cloudv2 "github.com/daudcanugerah/k6/output/cloud/expv2"
...
func TestNewOutputNameResolution(t *testing.T) {
	...
	cases := []struct {
		...
		{
			url: &url.URL{
				Opaque: "github.com/daudcanugerah/k6/samples/http_get.js",
			},
			expected: "http_get.js",
		},
		{
			url:      mustParse("http://github.com/daudcanugerah/k6/samples/http_get.js"),
			expected: "http_get.js",
		},
		{
